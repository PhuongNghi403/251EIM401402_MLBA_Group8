...
class Ui_CustomerHome(object):
    def setupUi(self, CustomerHome):
        ...
        self.input_rec_min_area = QtWidgets.QLineEdit(parent=self.group_recommend_input)
        self.input_rec_min_area.setObjectName("input_rec_min_area")
        self.input_rec_min_area.setPlaceholderText("Example: 80 (m²)")
        self.form_recommend.addRow("Min Area (m²)", self.input_rec_min_area)
        self.input_rec_min_bedrooms = QtWidgets.QLineEdit(parent=self.group_recommend_input)
        self.input_rec_min_bedrooms.setObjectName("input_rec_min_bedrooms")
        self.input_rec_min_bedrooms.setPlaceholderText("Example: 2")
        self.form_recommend.addRow("Min Bedrooms", self.input_rec_min_bedrooms)
        ...
        self.table_recommendation.setColumnCount(6)
        self.table_recommendation.setHorizontalHeaderLabels(["Price", "Area", "Bedrooms", "Floors", "Frontage", "City/Address"])
